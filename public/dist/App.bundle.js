...
function autocomplete(input, latInput, lngInput) {
    if (!input) return; //Por si no hay inputs
    ...
    //if someone hits enter at the address field, don't submit the form
...
var _typeAheade = __webpack_require__(10);

var _typeAheade2 = _interopRequireDefault(_typeAheade);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _autocomplete2.default)((0, _bling.$)('#address'), (0, _bling.$)('#lat'), (0, _bling.$)('#lng'));

(0, _typeAheade2.default)((0, _bling.$)('.search'));
